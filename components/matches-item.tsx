...
export default function MatchesItem({ matches }: {
    ...
    return (
        <div className="bg-[url(/bg-h&f.svg)] px-4 py-8 m-2 rounded-lg border-4 border-[#f3dc8a] md:max-w-7xl md:mx-auto">
            <div className="flex flex-col items-center m-2 gap-2 md:gap-4 md:mx-2 justify-center">
                <div className='border-b-1 border-[#f3dc8a] pb-2'>
                ...
                <div className="mt-5 text-white text-center bg-[#C1AA66] p-2 rounded-md md:p-4 md:mt-10">
